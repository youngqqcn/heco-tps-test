...
// Mint is a paid mutator transaction binding the contract method 0x13b4590e.
//
// Solidity: function Mint(address to, uint256 tokenId, bytes data) returns()
func (_Contract *ContractTransactor) Mint(opts *bind.TransactOpts, to common.Address, tokenId *big.Int, data []byte) (*types.Transaction, error) {
	return _Contract.contract.Transact(opts, "Mint", to, tokenId, data)
}

// Mint is a paid mutator transaction binding the contract method 0x13b4590e.
//
// Solidity: function Mint(address to, uint256 tokenId, bytes data) returns()
func (_Contract *ContractSession) Mint(to common.Address, tokenId *big.Int, data []byte) (*types.Transaction, error) {
	return _Contract.Contract.Mint(&_Contract.TransactOpts, to, tokenId, data)
}

// Mint is a paid mutator transaction binding the contract method 0x13b4590e.
//
// Solidity: function Mint(address to, uint256 tokenId, bytes data) returns()
func (_Contract *ContractTransactorSession) Mint(to common.Address, tokenId *big.Int, data []byte) (*types.Transaction, error) {
	return _Contract.Contract.Mint(&_Contract.TransactOpts, to, tokenId, data)
}
